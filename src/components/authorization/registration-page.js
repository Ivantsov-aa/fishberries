...
const RegistrationPage = ({ location, registrationSubmit, userId }) => {
    ...
    const onSubmit = data => {
        ...
        setUserInfo({ ...data, userPhoto: defaultUserPhoto });
        setNextStep(2);
    }
    ...
    const handleChosenSubscription = e => {
        ...
        const dateRegistration = `${currentDay + '.' + currentMonth + '.' + currentYear}`
        ...
        registrationSubmit({ ...userInfo, subscription: value, dateRegistration: dateRegistration });
        setRegistrationSteps(changedRegistrationSteps);
        setNextStep(3);
    }
        ...
        <section className='registration-page'>
            ...
            {currentStep === 1 &&
                <>
                    ...
                    <form className='registration-page__form' onSubmit={handleSubmit(onSubmit)}>
                        <label>
                            Логин *
                            <input
                                type='text'
                        ...
                        <div className='apply-agreement'>
                            <input
                                ...
                                checked={applyAgreementChecked}
                                required
                                onChange={() => { }}
                                className={errors?.apply_agreement && 'error'}
                            />
                            <label htmlFor='apply-agreement' onClick={() => setApplyAgreementChecked(!applyAgreementChecked)}>
            ...
            {currentStep === 3 && <section className='registration-page__complete'>
                ...
                <p>Готово!</p>
                <Link to={`/profile/${userId}/cabinet`}>Перейти в личный кабинет</Link>
            </section>}
        </section>
    )
}
